...
const Aboutme = () => {
  return (
    ...
    <div className=' dark:bg-zinc-900 max-w-screen-lg mx-auto block justify-center min-h-screen mt-32'>
        <h3 className=' text-sky-700 decoration-4 decoration-sky-700 z-10 font-medium text-4xl text-center pb-0'>About me</h3>
        ...
        <div className=' max-w-screen-lg flex gap-10'>
          ...
          <div className=' w-1/2'>
            <h3 className=' text-white z-10 font-medium text-2xl text-center '>Hola, Mi nombre es Uriel Martinez Pascual</h3>
            ...
            <div>
              <p className='text-gray-400'>Soy Desarrollador web. De manera independiente he realizados proyectos  y colaboraciones que me han ayudado a seguir desarrollándome, 
                ...
                <a href='https://drive.google.com/file/d/1n6oJQwLKgMGf9g_vcatMBpKBaU9dlRLK/view?usp=sharing'>
