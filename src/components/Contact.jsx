...
const Contact = () => {
    return (
        <>
            <div id='contact' className=" container mx-auto max-w-screen-lg mb-14 xlg:mb-0 xl:min-h-screen px-5 sm:px-20 lg:px-5">
            ...
            <IoRemoveOutline className='text-sky-700 mx-auto h-10 w-20 pt-0 mb-10 hover:text-sky-700'/>
                <div className=' block lg:flex gap-10'>
                    ...
                    <div className=' w-auto lg:w-1/2 text-zinc-300 mx-auto mt-7 lg:mt-0 mb-5 lg:mb-5'>
                        <p className=' text-base md:text-xl text-zinc-300 mb-10'>Escribe un mensaje, llama o contactame atraves de mis redes sociales.</p>
                        <div className=' lg:mt-24 lg:mb-0'>
                        <a href="https://www.linkedin.com/in/uriel-martinez-41ab2a116/" className=' flex gap-3 my-7 items-center text-sm lg:text-base hover:text-sky-700'> <BsLinkedin className=" w-8 h-8" />LINKEDIN</a>
                        <a href="https://github.com/Martz94" className=' flex gap-3 my-7 items-center text-sm lg:text-base hover:text-sky-700'><BsGithub className=" w-8 h-8" />GITHUB</a>
                        <a href="https://mail.google.com/" className=' flex gap-3 my-7 items-center text-sm lg:text-base hover:text-sky-700'><AiTwotoneMail className=" w-8 h-8" />urielmartzpascual@gmail.com</a>
                        <button className=" flex items-center gap-1 text-sky-600 hover:text-white pe-2">
                          <BsTelephoneForwardFill className=' h-7 w-7' /><p className=' text-transparent hover:text-sky-700'>921 123 75 12</p>
                      </button>
                        </div>
                    </div>
                </div>
